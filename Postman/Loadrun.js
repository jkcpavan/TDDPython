...
var path = require('path'), // ensures that the path is consistent, regardless of where the script is run from
     ...
     */
    options = {
        collection: path.join(__dirname, 'PythonTDD.postman_collection.json'),
        iterationData: path.join(__dirname, 'Data.json'),
        environment: path.join(__dirname, 'Development.postman_environment.json'),
        reporters: 'cli',
        iterationCount: 10
    },
